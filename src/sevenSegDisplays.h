 ...
 *
 * The class implements a hardware independent seven segment object. The data to be displayed by the physical display after generated is stored in a buffer, that will be shared with the underlying hardware display.
 *
...
public:
     ...
     *
     * @param dspUndrlHwPtr A pointer to the underlying hardware display object.
     *
     *  The underlying hardware display is the physical device used to display the information generated by this class objects and shared through it's buffer.
    ...
    bool blink();
    /**
     * @brief Makes the displayed contents blink using the timings passed as parameters.
     *
     * This blink() method implementation first calls the setBlinkRate(const unsigned long, const unsigned long) method for setting the timing parameters. If the timing parameters succeed, a blink() -no parameters- is invoked afterwards.
     *
     ...
     * - The display was in **waiting mode**, which cannot coexist with the **blinking mode**.
     * - One or more of the parameters passed was out of range. The blinking won't be started.
     * - The display was already set to blink, no new blink() method execution migth be invoked unless the display is not blinking, i.e. isBlinkin() method returns a false value.
     */
