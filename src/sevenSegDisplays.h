 ...
 *
 * The class implements a hardware independent seven segment display object. The data to be shown by the physical display, after generated, is stored in a buffer that will be shared with the underlying hardware display.
 *
...
public:
     ...
     *
     * @param dspUndrlHwPtr A pointer to the underlying hardware display, a SevenSegDispHw instantiable subclass object.
     *
    ...
    ~SevenSegDisplays();
    /**
     * @brief Starts the underlying hardware services needed to keep the display data visible and updated.
     *
     ...
     *
     * @retval true: If the display was not already set to blink of if it was already running
    ...
    /**
     * @brief Gets the quantity of digits -ports- of the display as informed by the underlying hardware (**UHW**)
     *
     ...
     *
     * The speed at witch the physical displays might be turned on and off is limited. In the case of this parameter a too much high value might void the blinking strobe effect of being perceived, giving the sensation that the display is fixed on, or was cleared from values. So a higher limit is imposed.
     *
     ...
     *
     * The speed at witch the physical displays might be turned on and off are limited. In the case of this parameter a too much low value might avoid the blinking strobe effect of being perceived, or be not tolerated by the underlying hardware, giving the sensation that the display is fixed on, or was cleared from values. So a lower limit is imposed.
     *
